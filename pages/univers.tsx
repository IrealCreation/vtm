    ...
    return(
        <>
            ...
            <section className="regles main-container">
                ...
                <p>Car la principale spécificité de cet univers, et ce qui d&apos;ailleurs lui donne son nom, est le &quot;Monde des Ténèbres&quot;, qui désigne tout un pan de la réalité demeurant inconnu et caché de la grande majorité des êtres humains qui vivent paisiblement leur vie et qui n&apos;apparaît en général qu&apos;au travers des contes, mythes et légendes urbaines.</p>
                ...
                <p>Tout caïnite est un ancien humain qui a été transformé dans un processus que l&apos;on nomme l&apos;Etreinte, qui implique pour un vampire de quasiment vider de son sang sa proie avant de l&apos;abreuver du sien. Le caïnite nouvellement créé est désigné comme <em>infant</em>, et celui qui l&apos;a créé est son <em>sire</em>.</p>
                <p>Une fois transformé, un caïnite se retrouve confronté à la <em>Soif</em>, cette pulsion quasiment animale qui le pousse à s&apos;abreuver de sang d&apos;êtres vivants, et qui constitue le trait prédominant de la <em>Bête</em> en son sein. Pour contrebalancer ces aspects, il est important de préserver dans une certaine mesure son <em>Humanité</em> ; celle-ci peut prendre plusieurs formes selon les individus - codes moraux, préceptes religieux, philosophie éthique, attachements émotionnels - mais elle permet dans tous les cas de ne pas se transformer en monstre féral incapable de contrôler ses pulsions.</p>
                ...
                <p>Si les vampires représentent un danger sérieux pour tout humain dont ils décideraient de faire leur victime, ils savent qu&apos;ils ne sont de taille à résister à l&apos;humanité toute entière si celle-ci venait à apprendre au grand jour leur existence et décidait d&apos;y mettre un terme. Plusieurs fois par le passé, de terribles inquisitions ont entraîné la mort d&apos;innombrables caïnites. C&apos;est pour cela qu&apos;il a été décidé que la meilleure armure serait celle du secret et qu&apos;un code a été instauré afin de faire respecteur celui-ci : la <em>Mascarade</em>. Ce code énonce que tout vampire risquant de dévoiler trop largement son existence aux humains devrait être mis à mort par ses pairs.</p>
                <p>Les caïnites sont des prédateurs par nature solitaire, mais ils savent que l&apos;union fait également la force. Un ordre social s&apos;est instauré parmi eux, fondé principalement sur le pouvoir de l&apos;ancienneté et sur des rapports de fidélité de style féodal. Deux clans ont pris forme aux alentours du XVe siècle, quand la Mascarade s&apos;est instaurée : la <em>Camarilla</em> et le <em>Sabbat</em>, désormais ennemis mortels mais dont la structure se ressemble pourtant beaucoup.</p>
                <p>Aujourd&apos;hui, la Camarilla contrôle la majorité de l&apos;Occident. Son ordre hiérarchique est centré sur des villes contrôlées chacunes par un Prince, monarque d&apos;apparence absolu mais devant veiller à l&apos;équilibre des forces et à la satisfaction de ses soutiens. Chaque sire est responsable de son infant mais dispose d&apos;une autorité totale sur lui, y compris du droit de le mettre à mort s&apos;il ne satisfait à ses attentes.</p>
                <p>Une troisième faction s&apos;est formée en opposition à cet ordre gérontocratique et monarchique, prônant des valeurs plus égalitaires et démocratiques : les <em>Anarchs</em>. Leur situation varie de la coexistence pacifique à la rébellion ouverte en fonction des villes, fussent-elles contrôlées par la Camarilla ou le Sabbat.</p>
